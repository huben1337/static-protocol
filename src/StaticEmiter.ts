 ...
 */
const StaticEmiter = <T extends StaticProtocolType<any, boolean>, M extends Array<keyof T> | undefined> (proto: T, emiterCallback: (data: FullyReadonlyBuffer) => any, mask?: M) => {
